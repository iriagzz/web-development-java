     	...
     	<div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="${pageContext.request.contextPath}/contatoControllerServlet?id=${id}&action=editarServlet" method="post">
                ...
                <div class="form-group">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                  	<input type="email" class="form-control form-control-user" id="email" 
                  		value= "${email}" required="required" name="email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="telefone" 
                    	value= "${telefone}" required="required" name="telefone">
                  </div>
                </div>
                <div align="center">
