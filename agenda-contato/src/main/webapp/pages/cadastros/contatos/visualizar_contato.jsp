                ...
                <div class="form-group">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="nome" 
                    	 value= "${nome}" name="nome" readonly="readonly"> 
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                  	<input type="email" class="form-control form-control-user" id="email" 
                  		value= "${email}" required="required" name="email" readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="telefone" 
                    	value= "${telefone}" required="required" name="telefone" readonly="readonly">
                  </div>
                </div>
                <div align="center">
